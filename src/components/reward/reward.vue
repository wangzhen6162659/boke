<!--<template>-->
  <!--<div class="reward">-->
  	<!--<div class="reward-content">-->
  		...
  		<!--</div>-->
  		<!--<div class="content">-->
  			<!--&lt;!&ndash;<div class="reward_list dw-boot-col-lg-3 dw-boot-col-md-4 dw-boot-col-sm-6">&ndash;&gt;-->
	  			<!--&lt;!&ndash;<img src="http://www.daiwei.org/new/WechatIMG1.jpeg" alt="支付宝">&ndash;&gt;-->
	  		<!--&lt;!&ndash;</div>&ndash;&gt;-->
	  		<!--&lt;!&ndash;<div class="reward_list dw-boot-col-lg-3 dw-boot-col-md-4 dw-boot-col-sm-6">&ndash;&gt;-->
	  			<!--&lt;!&ndash;<img src="http://www.daiwei.org/new/WechatIMG2.jpeg" alt="微信">&ndash;&gt;-->
	  		<!--&lt;!&ndash;</div>&ndash;&gt;-->
  		<!--</div>-->
